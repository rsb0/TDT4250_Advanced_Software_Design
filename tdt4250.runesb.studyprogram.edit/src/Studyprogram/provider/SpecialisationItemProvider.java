...
/**
 * This is the item provider adapter for a {@link Studyprogram.Specialisation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecialisationItemProvider extends SemesterContainerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramPackage.Literals.SPECIALISATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyprogramPackage.Literals.SPECIALISATION__SUB_SPECIALISATION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Specialisation.class)) {
			case StudyprogramPackage.SPECIALISATION__NAME:
				...
				return;
			case StudyprogramPackage.SPECIALISATION__SUB_SPECIALISATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyprogramPackage.Literals.SPECIALISATION__SUB_SPECIALISATION,
				 StudyprogramFactory.eINSTANCE.createSpecialisation()));
	}
