 ...
 * @generated
 */
public class ProgramItemProvider extends SemesterContainerItemProvider {
	/**
	...
	protected void addProgramCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_programCode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_programCode_feature", "_UI_Program_type"),
				 StudyprogramPackage.Literals.PROGRAM__PROGRAM_CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNumberOfYearsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_numberOfYears_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_numberOfYears_feature", "_UI_Program_type"),
				 StudyprogramPackage.Literals.PROGRAM__NUMBER_OF_YEARS,
				 true,
				 false,
				 false,
	...
	protected void addProgramTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_programType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_programType_feature", "_UI_Program_type"),
				 StudyprogramPackage.Literals.PROGRAM__PROGRAM_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyprogramPackage.Literals.PROGRAM__SPECIALISATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyprogramPackage.Literals.PROGRAM__SPECIALISATION,
